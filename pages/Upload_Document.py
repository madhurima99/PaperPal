...
with st.form("document_input"):
    ...
    with row_1[0]:
        embeddings = st.text_input(
            "Model Name of the Hugging Face Embeddings", value="sentence-transformers/all-mpnet-base-v2"
        )
...
if save_button:
    ...
    rag_functions.embedding_storing(
        embeddings, split, create_new_vs, existing_vector_store, new_vs_name
    )